    ...
    <div class="row">
             ...
             <div class="subNav">
                 <ul>
                     <li>
                         <a href="#">留学商城</a>
                         &gt;
                         <a href="/cn/admission-requirement">留学动态</a>
                         &gt;
            ...
            <div class="detailContent">
                <ul>
                    ...
                    foreach($data['data'] as $v) {
                        ?>
                        <li>
                            <a href="/cn/admission-requirement/detail/<?php echo $_GET['catid']?>-<?php echo $v['id']?>.html" class="title"><?php echo $v['title']?></a>
                            <span><?php echo $v['age']?></span>

                            <p><?php echo $v['answer']?>
                                <a href="/cn/admission-requirement/detail/<?php echo $_GET['catid']?>-<?php echo $v['id']?>.html" class="detail">[详情]</a></p>
        ...
        <script type="text/javascript">
            $('.iPage').click(function(){
                ...
                location.href ="/cn/admission-requirement/body/page-"+page+"/<?php echo $_GET['catid']?>.html";
            })
