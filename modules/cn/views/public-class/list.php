...
<div class="open-detailsTitle">
    <ul>
        ...
        <li><a href="http://open.viplgw.cn">SmartApply公开课</a></li>
        <li> &gt;</li>
...
<div class="list-content">
    <div class="list-left">
                    ...
                    <li>
                        <div class="inlist-left">
                            ...
                            <div class="bottList">
                                ...
                                <a href="http://open.viplgw.cn/public-class/<?php echo $v['id']?>.html">查看详情</a>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            function goPage(){
                ...
                var page = $('.pageNumber').val();
                location.href="http://open.viplgw.cn/public-class/<?php echo $category?>/"+page+".html";
            }
        </script>
        <div class="page pagetop">
            <ul>
                <li>总数：<?php echo $count?></li>
                <li><a href="<?php echo "http://open.viplgw.cn/public-class/".$category."/1.html"?>">首页</a></li>
                <li><a href="<?php echo ($page >1)?'http://open.viplgw.cn/public-class/'.$category.'/'.($page-1).'.html':'javascript:;'?>">上一页</a></li>
                <li><a href="<?php echo ($page <$total)?'http://open.viplgw.cn/public-class/'.$category.'/'.($page+1).'.html':'javascript:;'?>">下一页</a></li>
                <li class="mr"><a href="<?php echo "http://open.viplgw.cn/public-class/".$category."/$total.html"?>">尾页</a></li>
    ...
    <div class="list-right">
        ...
        <div class="dimensionFont">
            <h4>GMAT-Lindy老师微信</h4>
            <span>报名GMAT公开课或获取往期课程音频</span><br>
        ...
        <div class="dimensionFont">
            <h4>GMAT-chris老师微信</h4>
            <span>报名GMAT公开课或获取往期课程音频</span><br>
            <span>加“chris老师”微信为好友！</span>
        </div>
        <div class="dimension">
            <span></span>
            <img src="/cn/images/toefl-Lorraine.jpg" alt="二维码图片"/>
        </div>

        <div class="dimensionFont">
            <h4>Toefl-Lorraine老师微信</h4>
            <span>报名托福公开课或获取往期课程音频</span><br>
            <span>加“Lorraine老师”微信为好友！</span>
        </div>
        <div class="dimension">
            <span></span>
        ...
        <div class="dimension">
            <span></span>
            <img src="/cn/images/toefl-app.jpg" alt="二维码图片"/>
        </div>
        <div class="dimensionFont">
            <h4>雷哥托福 APP下载</h4>
            <span>下载雷哥托福APP，随时随地练习托福</span>
        </div>
    </div>
    <div style="clear: both"></div>
</div>
