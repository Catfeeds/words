...
<div class="open-commonStyle">
    <ul>
        ...
        <div class="open-commonTitle">
            <a href="http://open.viplgw.cn/public-class/162/1.html">more</a>
        ...
        foreach($data as $v) {
            ...
            <li>
                ...
                <p><a href="http://open.viplgw.cn/public-class/<?php echo $v['id']?>.html"><?php echo $v['name']?></a></p>
        ...
        <div style="clear: both"></div>
        <div class="open-commonTitle">
            <a href="http://open.viplgw.cn/public-class/163/1.html">more</a>
            <div style="clear: both"></div>
        </div>
        <li class="noBorderLi">
        ...
        <div class="open-commonTitle">
            <a href="http://open.viplgw.cn/public-class/150/1.html">more</a>
            <div style="clear: both"></div>
        </div>
        <li class="noBorderLi">
