                    ...
                    <div class="col-md-6 TodayBorder">
                        ...
                        foreach($data as $v) {
                            ...
                            <div class="col-md-8 headlines">
                                ...
                                <span><?php echo $v['answer']?></span><a href="/cn/admission-requirement/body/241.html">[更多]</a>
                            </div>
                            <div style="clear: both"></div>
                            <a href="/cn/admission-requirement/detail/241-<?php echo $v['id']?>.html"><?php echo $v['title']?></a>
                            <?php
                        }
                        ?>
                    </div>
...
<!--                        </ul>-->
                    ...
                    <div class="formalBd">
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getClass(['where' => 'c.pid=0','fields' => 'answer','category' => '242','page'=>1,'pageSize' => 10,'order' => 'c.createTime DESC']);
                            foreach($data as $v) {
                                ?>
                                <li>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getClass(['where' => 'c.pid=0','fields' => 'answer','category' => $v['id'],'page'=>1,'pageSize' => 10,'order' => 'c.createTime DESC']);
                    foreach($data as $va) {
                        ?>
                        <li>
...
<!--                        </ul>-->
                    ...
                    <div class="formalBd">
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getClass(['where' => 'c.pid=0','fields' => 'answer','category' => '244','page'=>1,'pageSize' => 10,'order' => 'c.createTime DESC']);
                            foreach($data as $v) {
                                ?>
                                <li>
...
<!--                        </ul>-->
                    ...
                    <div class="formalBd">
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getClass(['where' => 'c.pid=0','fields' => 'answer','category' => '245','page'=>1,'pageSize' => 10,'order' => 'c.createTime DESC']);
                            foreach($data as $v) {
                                ?>
                                <li>
