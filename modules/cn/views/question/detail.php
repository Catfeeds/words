               ...
               <div class="answerTop">
                   <div class="col-md-2 leftImg">
                       <div class="headPortrait">
                           <img src="<?php echo $data['image']?>" alt="默认头像"/>
                       </div>
                       <p><?php echo isset($data['nickname'])? $data[0]['nickname'] : '匿名'?></p>
                   </div>
                   <div class="col-md-7">
                           ...
                           <li>
                               ...
                               <?php if (!empty($v['adviser'])) { ?>
                                       ...
                                       <div class="topPurple">
                                           ...
                                           <h4><?php echo isset($v['nickname']) ? $v['nickname'] : '匿名' ?></h4>
                                               ...
                                               <li>
                                                   <div class="secondComment">
                                                       ...
                                                       <div class="col-md-11 replyRight">
                                                           <h4><?php echo isset($va['nickname']) ? $va['nickname'] : '匿名' ?>回复<?php echo isset($v['adviser']['name']) ? $v['adviser']['name'] : $v['nickname'] ?> <span><?php echo $va['addTime']?></span></h4>
