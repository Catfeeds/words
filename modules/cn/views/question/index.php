                                    ...
                                    foreach($question['data'] as $v){ ?>
                                        <li>
                                            <div class="col-md-2 leftDefault">
                                                ...
                                                <p><?php echo isset($v['nickname'])?$v['nickname']:'匿名'?></p>
                                            </div>
                                            <div class="col-md-10 rightInfo">
                                                ...
                                                <div class="col-md-11 rightFont">
                                                    ...
                                                    <?php }?>
                                                    <span><?php echo isset($v['nickname'])?$v['nickname']:'匿名'?> 发起了问题 • <?php echo $v['follow']?>人关注 • <?php echo isset($v['answer'])?count($v['answer']): 0?>个回复 • <?php echo $v['browse']?>次浏览<?php if(isset($v['answer'][0]['addTime'])) {$gettime = new Method();$sj = time() - strtotime($v['answer'][0]['addTime']);echo " • ".$gettime->gmstrftimeA($sj);
                                                        } ?></span>
                                                </div>
                                                <div style="clear: both"></div>
                                            </div>
