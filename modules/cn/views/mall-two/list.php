    ...
    <div class="row">
                ...
                <div class="detailContent">
                    <ul>
                        ...
                        foreach($data['data'] as $v) {
                            ?>
                            <li>
                                <a href="/cn/case/256-<?php echo $v['id']?>.html" class="title"><?php echo $v['name']?></a>
                                <span><?php echo $v['createTime']?></span>

                                <p><?php echo $v['answer']?>
                                    <a href="/cn/case/256-<?php echo $v['id']?>.html" class="detail">[详情]</a></p>
        ...
        <script type="text/javascript">
            $('.iPage').click(function(){
                ...
                location.href ="/cn/case/l-"+page+".html";
                <?php
                }
                ?>
            })
