...
<div class="synthesize">
    <ul>
        <li><a href="/course/category-<?php echo isset($_GET['category'])?$_GET['category']:0?>/type-<?php echo isset($_GET['type'])?$_GET['type']:0?>/page-<?php echo isset($_GET['page'])?$_GET['page']:1?>.html">综合</a></li>
        <li><a href="/course/category-<?php echo isset($_GET['category'])?$_GET['category']:0?>/type-<?php echo isset($_GET['type'])?$_GET['type']:0?>/page-<?php echo isset($_GET['page'])?$_GET['page']:1?>/buyNum-<?php echo isset($_GET['buyNum'])&&$_GET['buyNum'] == 1?2:1?>.html">销量 <?php if(!isset($_GET['buyNum'])){echo '';}elseif($_GET['buyNum'] == 1){echo '<i class="fa  fa-long-arrow-down"></i>';}else{echo '<i class="fa  fa-long-arrow-up"></i>';}?></a></li>
...
<script type="text/javascript">
    function selectPage(_this){
        ...
        location.href ="/course/category-<?php echo isset($_GET['category'])?$_GET['category']:0?>/type-<?php echo isset($_GET['type'])?$_GET['type']:0?>/page-"+page+str+".html";
    }
    function clickClassify(){
        ...
        location.href ="/course/category-"+category+"/type-"+type+"/page-1"+".html"
    }
