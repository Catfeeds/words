...
<div class="open-detailsC">
    <div class="open-Dleft">
        <div class="detail-top">
            ...
            <div class="detailT-right">
                ...
                <?php
                    if($parent['duration']) {
                        ?>
                        <a href="http://open.viplgw.cn/public-class/back/<?php echo $parent['id']?>.html">课程回放</a>
                    <?php
                    }else {
                        ?>
        ...
        <div class="open-commonTitle">
            <h4><img src="/cn/images/openD_titleIcon02.png" alt="图标"><a href="#">您可能感兴趣...</a></h4><a href="http://open.viplgw.cn">更多</a>
        </div>
                                ...
                                while( $ToStartMonth < $ToEndMonth ) {
                                    ...
                                    <li>
                                        ...
                                        if (in_array($NewMonth, $activityDate)){
                                            ?>
                                            <a href="http://open.viplgw.cn/public-class/<?php echo $activity[$NewMonth]['id']?>.html" class="on on-erji"><?php echo date("d", strtotime($NewMonth)) ?></a>
