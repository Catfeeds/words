...
<div class="secondNav">
    <ul>
        <li><a href="/">留学商城</a></li>
        <li>&gt;</li>
        <li><a href="#"><?php echo $_GET['content']?></a></li>
    </ul>
</div>
<!--灰色选择类别-->
...
<!--        --><?php
//        $category = \app\modules\cn\models\Category::find()->where("pid=155")->all();
...
<!--    </ul>-->
<!--    <ul>-->
<!--        <li class="diffLi">课程类型：</li>-->
<!--        <li  data-value="0" class="--><?php //echo isset($_GET['type'])&&$_GET['type']==0?'on':''?><!-- type diffLi" diff-value='1'>全部</li>-->
<!--        <li data-value="198" class="--><?php //echo isset($_GET['type'])&&strstr($_GET['type'],"198")?'on':''?><!-- type">直播课</li>-->
<!--        <li data-value="199" class="--><?php //echo isset($_GET['type'])&&strstr($_GET['type'],"199")?'on':''?><!-- type">视频课</li>-->
<!--    </ul>-->
<!--</div>-->
<!--按照什么搜索-->
<div class="synthesize">
    <ul>
        <li><a href="/search/content-<?php echo isset($_GET['content'])?$_GET['content']:0?>/page-<?php echo isset($_GET['page'])?$_GET['page']:1?>.html">综合</a></li>
        <li><a href="/search/content-<?php echo isset($_GET['content'])?$_GET['content']:0?>/page-<?php echo isset($_GET['page'])?$_GET['page']:1?>/buyNum-<?php echo isset($_GET['buyNum'])&&$_GET['buyNum'] == 1?2:1?>.html">销量 <?php if(!isset($_GET['buyNum'])){echo '';}elseif($_GET['buyNum'] == 1){echo '<i class="fa  fa-long-arrow-down"></i>';}else{echo '<i class="fa  fa-long-arrow-up"></i>';}?></a></li>
        ...
        <li><a href="/search/content-<?php echo isset($_GET['content'])?$_GET['content']:0?>/page-<?php echo isset($_GET['page'])?$_GET['page']:1?>/time-<?php echo isset($_GET['time'])&&$_GET['time'] == 1?2:1?>.html">最新 <?php if(!isset($_GET['time'])){echo '';}elseif($_GET['time'] == 1){echo '<i class="fa  fa-long-arrow-down"></i>';}else{echo '<i class="fa  fa-long-arrow-up"></i>';}?></a></li>
    </ul>
</div>
<!--内容部分-->
...
<script type="text/javascript">
    function selectPage(_this){
        ...
        location.href ="/search/content-<?php echo isset($_GET['content'])?$_GET['content']:0?>/page-"+page+str+".html";
    }
    function clickClassify(){
        ...
        location.href ="/course/content-"+category+"/type-"+type+"/page-1"+".html"
    }
