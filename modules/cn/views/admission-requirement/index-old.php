...
<!--                        </a>-->
                ...
                <div class="newHeadlines">
                    <div class="l_headlines">
                        <a href="javascript:void(0);" class="prev_a"><img src="/cn/images/gl_leftJ.png" alt="左边箭头"/></a>
                        <a href="javascript:void(0);" class="next_a"><img src="/cn/images/gl_rightJ.png" alt="右边箭头"/></a>
                        <div class="l_h_hd">
                            <ul>
                                <?php
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <img src="<?php echo $v['image']?>" alt="小图片"/>
                                    </a>
                                </li>
                                <?php
                                }
                        ...
                        <div class="l_h_bd">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="big_box">
                                        <a href="javascript:void(0);">
                                            <img src="<?php echo $v['image']?>" alt="大图片"/>
                                        </a>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <script type="text/javascript">
                         jQuery(".l_headlines").slide({titCell:".l_h_hd li",mainCell:".l_h_bd",prevCell:".prev_a",nextCell:".next_a",autoPlay:true});
                    </script>
                    <div class="r_headlines">
                        <h1>今日头条</h1>
                        <ul>
                            <?php
                            ...
                            ?>
                            <li>
                                <h4><a href="/cn/admission-requirement/detail/241-<?php echo $v['id'] ?>.html"><?php echo $v['title'] ?></a></h4>
                ...
                <div class="formalities formalSlide04">
                    <div class="formalHd">
                        <h4><a href="/cn/admission-requirement/body/245.html">留学规划</a></h4>
                        <p><a href="/cn/admission-requirement/body/245.html">More</a></p>
                        <!--                        <ul>-->
                        <!--                            <li><a href="#">高中留学</a></li>-->
                        <!--                            <li><a href="#">本科转学</a></li>-->
                        <!--                            <li><a href="#">本科留学</a></li>-->
                    ...
                    <div class="formalBd">
                        <ul>
                            ...
                            foreach($data as $v) {
                                ?>
                                <li>
                                    <a href="/cn/admission-requirement/detail/245-<?php echo $v['id']?>.html"><?php echo $v['title']?></a>
                                    <!--                                    <span>--><?php //echo $v['createTime']?><!--</span>-->
                                    <div class="miao_shu"><?php echo $v['answer']?></div>
                                </li>
                            <?php
                            }
                            ?>
                ...
                <div class="formalities formalSlide02">
                    <div class="formalHd">
                        <h4><a href="/cn/admission-requirement/body/243.html">留学考试</a></h4>
                        <p><a href="/cn/admission-requirement/body/243.html">More</a></p>
                        <ul>
                            <?php
                        ...
                        foreach($ks_class as $v){ ?>
                            <ul>
                                ...
                                foreach($data as $va) {
                                    ?>
                                    <li>
                                        <a href="/cn/admission-requirement/detail/243-<?php echo $va['id']?>.html"><?php echo $va['title']?></a>
<!--                                        <span>--><?php //echo $va['createTime']?><!--</span>-->
                                        <div class="miao_shu"><?php echo $va['answer']?></div>
                                    </li>
                                <?php
                                }
                                ?>
                ...
                <div class="formalities formalSlide03">
                    <div class="formalHd">
                        <h4><a href="/cn/admission-requirement/body/244.html">留学国家</a></h4>
                        <p><a href="/cn/admission-requirement/body/244.html">More</a></p>
                        <!--                        <ul>-->
                        <!--                            <li><a href="#">美国</a></li>-->
                        <!--                            <li><a href="#">英国</a></li>-->
                        <!--                            <li><a href="#">香港</a></li>-->
                    ...
                    <div class="formalBd">
                        <ul>
                            ...
                            foreach($data as $v) {
                                ?>
                                <li>
                                    <a href="/cn/admission-requirement/detail/244-<?php echo $v['id']?>.html"><?php echo $v['title']?></a>
<!--                                    <span>--><?php //echo $v['createTime']?><!--</span>-->
                                    <div class="miao_shu"><?php echo $v['answer']?></div>
                                </li>
                            <?php
                ...
                <div class="formalities formalSlide01">
                    <div class="formalHd">
                        <h4><a href="/cn/admission-requirement/body/242.html">留学手续</a></h4>
                        <p><a href="/cn/admission-requirement/body/242.html">More</a></p>
                        <!--                        <ul>-->
                        <!--                            <li><a href="#">留学流程</a></li>-->
                        <!--                            <li><a href="#">留学文书</a></li>-->
                        <!--                            <li><a href="#">留学简历</a></li>-->
                    ...
                    <div class="formalBd">
                        <ul>
                            ...
                            foreach($data as $v) {
                                ?>
                                <li>
                                    <a href="/cn/admission-requirement/detail/242-<?php echo $v['id']?>.html"><?php echo $v['title']?></a>
                                    <!--                                    <span>--><?php //echo $v['createTime']?><!--</span>-->
                                    <div class="miao_shu"><?php echo $v['answer']?></div>
                                </li>
                            <?php
        ...
        <div class="col-md-3">
            <div class="commonRight" id="speScroll">
                <div class="TopList">
...
//        $(function(){
////            右侧滚动
//            var scrollbox = $("#speScroll .TopList");	//获取class为ScrollBox的DOM元素并用"scrollbox"表示
//            var position = scrollbox.position();	//获取DOM元素的当前位置并用"position"表示
//            var l_Height=$(".commonLeft")[0].offsetHeight;
//            $(window).scroll(function(){	//当滚动条滚动时出发以下内容
//                if($(document).scrollTop()>700){
//                    scrollbox.addClass("fixed");
//                    var offsetTop = $(document).scrollTop();	//获取"position"距离顶部的位置 + 滚动条距离网页顶部的位置 并用"offsetTop"表示为当前位置
//                    scrollbox.animate({ top: offsetTop*0.01 }, { duration: 500, queue: false });	//使用缓动动画移动到当前位置
//                    if(offsetTop+350>=$(document).height()-$(window).height()){
//                        scrollbox.stop(true);
////                        $(".ProductList").addClass("hei-on");
////                        $(".interestSchool").addClass("hei-two");
//                        scrollbox.removeClass("fixed");
//                        scrollbox.removeAttr("style");
//                        scrollbox.addClass("boxFixed");
//                        $(".ProductList").addClass("hei-on");
//                    }else{
//                        $(".ProductList").removeClass("hei-on");
////                        $(".interestSchool").removeClass("hei-two");
//                    }
//                }else{
//                    scrollbox.removeClass("fixed");
//                    scrollbox.removeClass("boxFixed");
////                    scrollbox.animate({ top: 175 }, { duration: 500, queue: false });	//使用缓动动画移动到当前位置
//                }
//
//            })
//
