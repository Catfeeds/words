...
<div class="caseNav">
    <ul>
        <li>
            <a href="/cn/case.html"><span>留学案例</span></a>
        </li>
        <li class="on">
...
<div class="caseBorder">
    <div class="purple-title">
        <span>GMAT高分捷报</span>
        <a href="/cn/case/list-287.html">MORE</a>
    </div>
    <div class="col-md-6">
        <div class="col-md-3">
            <div class="book-left">
            ...
            <div class="book-right">
                <ul>
                    ...
                    foreach($data as $v) {
                        ?>
                        <li>
                            <a href="/cn/case/287-<?php echo $v['id']?>.html"><i>•</i><?php echo $v['name']?></a>
                        </li>
                        <?php
                    }
                    ?>
    ...
    <div class="caseBorder">
        <div class="purple-title">
            ...
            <a href="/cn/case/list-288.html">MORE</a>
        </div>
        <div class="col-md-6">
            <div class="col-md-3">
                <div class="book-left">
                ...
                <div class="book-right">
                    <ul>
                        ...
                        foreach($data as $v) {
                            ?>
                            <li>
                                <a href="/cn/case/288-<?php echo $v['id']?>.html"><i>•</i><?php echo $v['name']?></a>
                            </li>
                            <?php
                        }
                        ?>
                ...
                <div class="greyB-ul">
                    <ul>
                        ...
                        ?>
                            <li>
                                <i>•</i>
                                <a href="/cn/case/267-<?php echo $v['id']?>.html"><?php echo $v['name']?></a>
                            </li>
                        <?php
                        }
                        ?>
