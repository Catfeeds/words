            ...
            <div class="bs-example">
                ...
                <div class="col-md-6">
                    <div class="caseBorder">
                        <div class="purple-title">热门案例<a href="/cn/case/list-281.html">MORE</a></div>
                        <div class="col-md-3">
                            <div class="book-left">
                                <?php
                ...
                <div class="col-md-6">
                    <div class="caseBorder">
                        <div class="purple-title">美国留学成功案例<a href="/cn/case/list-282.html">MORE</a></div>
                        <div class="col-md-3">
                            <div class="book-left">
                                <?php
                            ...
                            <div class="book-right">
                                <ul>
                                    ...
                                    foreach ($data as $v) {
                                        ?>
                                        <li>
                                            <a href="/cn/case/282-<?php echo $v['id'] ?>.html">●<?php echo $v['name'] ?></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                ...
                <div class="col-md-6">
                    <div class="caseBorder">
                        <div class="purple-title">英国留学成功案例<a href="/cn/case/list-283.html">MORE</a></div>
                        <div class="col-md-3">
                            <div class="book-left">
                                <?php
                            ...
                            <div class="book-right">
                                <ul>
                                    ...
                                    foreach ($data as $v) {
                                        ?>
                                        <li>
                                            <a href="/cn/case/283-<?php echo $v['id'] ?>.html">●<?php echo $v['name'] ?></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                ...
                <div class="col-md-6">
                    <div class="caseBorder">
                        <div class="purple-title">澳洲加拿大留学成功案例<a href="/cn/case/list-284.html">MORE</a></div>
                        <div class="col-md-3">
                            <div class="book-left">
                                <?php
                            ...
                            <div class="book-right">
                                <ul>
                                    ...
                                    foreach ($data as $v) {
                                        ?>
                                        <li>
                                            <a href="/cn/case/284-<?php echo $v['id'] ?>.html">●<?php echo $v['name'] ?></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                ...
                <div class="col-md-6">
                    <div class="caseBorder">
                        <div class="purple-title">新加坡香港留学成功案例<a href="/cn/case/list-285.html">MORE</a></div>
                        <div class="col-md-3">
                            <div class="book-left">
                                <?php
                            ...
                            <div class="book-right">
                                <ul>
                                    ...
                                    foreach ($data as $v) {
                                        ?>
                                        <li>
                                            <a href="/cn/case/285-<?php echo $v['id'] ?>.html">●<?php echo $v['name'] ?></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                ...
                <div class="col-md-6">
                    <div class="caseBorder">
                        <div class="purple-title">欧洲留学成功案例<a href="/cn/case/list-286.html">MORE</a></div>
                        <div class="col-md-3">
                            <div class="book-left">
                                <?php
                            ...
                            <div class="book-right">
                                <ul>
                                    ...
                                    foreach ($data as $v) {
                                        ?>
                                        <li>
                                            <a href="/cn/case/286-<?php echo $v['id'] ?>.html">●<?php echo $v['name'] ?></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
...
<!--                            <tbody>-->
<!--                            --><?php
//                            $data = \app\modules\cn\models\Content::getClass(['fields' => 'cnName,article,problemComplement', 'category' => '281', 'page' => 1, 'pageSize' => 30]);
//                            foreach ($data as $v) {
//                                ?>
<!--                                <tr>-->
...
<!--                            </tbody>-->
                        ...
                        <ol class="pic_list">
                            ...
                            ?>
                            <li>
                                <div class="inb t_pic"><?php echo $v['cnName'] ?></div>
                                <div class="inb m_pic"><?php echo $v['problemComplement'] ?></div>
                                <div class="inb b_pci"><?php echo $v['article'] ?></div>
                            </li>
                            <?php } ?>
                        </ol>
                    </div>
