...
<footer>
    <div class="w12 tm" style="padding: 30px 0">
        ...
        <ul class="footer-list erm-3-wrap">
            ...
            <li>
                <a href="#"><div class="ft-icon"><img src="/cn/1111/images/icon-wx.png" alt=""></div>：雷哥GMAT</a>
                <div class="erm-3"><img src="/cn/1111/images/erm-6.jpg" alt=""></div>
            </li>
            <li>
                <a href="#"><div class="ft-icon"><img src="/cn/1111/images/icon-wx.png" alt=""></div>：雷哥托福</a>
                <div class="erm-3"><img src="/cn/1111/images/erm-7.jpg" alt=""></div>
            </li>
            <li>
                <a href="#"><div class="ft-icon"><img src="/cn/1111/images/icon-wx.png" alt=""></div>：雷哥雅思</a>
                <div class="erm-3"><img src="/cn/1111/images/erm-8.png" alt=""></div>
            </li>
            <li>
                <a href="#"><div class="ft-icon"><img src="/cn/1111/images/icon-wx.png" alt=""></div>：雷哥留学</a>
                <div class="erm-3"><img src="/cn/1111/images/erm-9.jpg" alt=""></div>
            </li>
        </ul>
        <div class="leige-tag inb">
            <div><img src="/cn/1111/images/logo-2.png" alt=""></div>
            <div class="ft-tag">
