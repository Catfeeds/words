...
<div class="open-detailsC">
    ...
    <div class="open-Dright">
        ...
        <div class="erweima">
            ...
            <h4 style="color: deepskyblue">[报名托福公开课或获取往期音频加微信为好友]</h4>
            <ul>
                <li>
                    <img src="/cn/images/toefl-Lorraine.jpg" alt="二维码">
                    <p style="color: deepskyblue">Lorraine老师微信</p>

                </li>
                <li>
                    <img src="/cn/images/toefl-gzh.jpg" alt="二维码">
                    <p style="color: deepskyblue">托福微信公众号</p>

                </li>
                <li>
                    <img src="/cn/images/toefl-app.jpg" alt="二维码">
                    <p style="color:deepskyblue">托福 APP下载</p>
